...
public void onClick(View v) {
        ...
        if (timelist.size()>0) {
            ...
            for (int i = 0; i < timelist.size(); i++) {
                ...
                {
                    Toast.makeText(FarmerHomeActivity.this, ""+timelist.get(i), Toast.LENGTH_SHORT).show();
                    productdel.child(timelist.get(i)).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
